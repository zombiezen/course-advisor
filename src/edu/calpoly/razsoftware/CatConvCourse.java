...
public class CatConvCourse
{
    ...
    String                  description;
    String                  name = "";
    Set<Set<CatConvCourse>> preRequisites; // list of lists for
                                           // possiblities, outside or,
                                           // inside and
    Set<Set<CatConvCourse>> coRequisites; // pre or co ^^
    ...
    public boolean equals(Object obj)
    {
        ...
        eq &= (number == ((CatConvCourse) obj).number); // has same course
                                                        // number
        return eq;
    }
    ...
    public CatConvCourse(List<String> major, int number, int units,
            String description)
    {
